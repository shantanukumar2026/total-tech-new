...
const SOLUTIONS: SolutionItem[] = [
  ...
  },
  {
    ...
    title: "Cloud Setup & Security",
    description:
      "Reliable cloud architecture on AWS, Azure, or GCP with automated backups, monitoring, and security controls.",
    imageSrc: "/assets/web-app/gettyimages-2262805356-1024x1024.jpg",
    imageAlt: "Cloud Infrastructure and Security",
    features: [
